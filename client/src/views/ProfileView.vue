...
const userInfo = {
    ...
    handle: 'MarcoLg',
    phone: '12345678',
    email: 'marcolg@example.com',
    imageUrl:
      'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.iconfinder.com%2Ficons%2F5692874%2Favatar_coding_computer_it_laptop_profile_programmer_icon&psig=AOvVaw3af4RvP2JCCqiM7vjvjl8d&ust=1673909327057000&source=images&cd=vfe&ved=0CBAQjRxqFwoTCPCCv6rUyvwCFQAAAAAdAAAAABAE',
  }
  const subNavigation = [
